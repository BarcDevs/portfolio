...
const data = {
    ...
    projects: [
        ...
        {
            title: "Dev-Flow",
            description: "A Stackoverflow inspired website with few additional features like AI based answers generation. Built using React (NextJS), TailwindCSS and MongoDB.",
            tags: [
                "nextjs",
                "react",
                "tailwindcss",
